      ...
      <SlideContainer>
        <SlidePanel sx={{flex: 1}}>
          <Lazy deps={[data]} fn={() => ChartTools.percentage({
            ...
            {_ => <PieChartIndicator title={m.hhWithoutIncome} value={_.percent}/>}
          </Lazy>
        </SlidePanel>
        <SlidePanel sx={{flex: 1}}>
          <Lazy deps={[data]} fn={() => ChartTools.percentage({
            ...
            {_ => <PieChartIndicator title={m.hhOutOfWork} value={_.percent}/>}
          </Lazy>
        </SlidePanel>
        <SlidePanel sx={{flex: 1}}>
          <Lazy deps={[data]} fn={() => ChartTools.percentage({
            ...
            {_ => <PieChartIndicator title={m.idpWithAllowance} value={_.percent}/>}
          </Lazy>
        </SlidePanel>
        <SlidePanel sx={{flex: 1}}>
          <Lazy deps={[data]} fn={() => ChartTools.percentage({
            ...
            {_ => <PieChartIndicator title={m.hhWithGapMeetingBasicNeeds} value={_.percent}/>}
          </Lazy>
        </SlidePanel>
      </SlideContainer>
