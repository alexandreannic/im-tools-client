      ...
      <Div column>
        <SlidePanel>
          ...
          <ChartBarSingleBy
            ...
            label={Protection_Hhs2.options.how_would_you_describe_the_relationship_between_member_of_the_host_community}
          ...
          <ChartBarMultipleBy
            ...
            filterValue={['unable_unwilling_to_answer']}
            label={Protection_Hhs2.options.what_factors_are_affecting_the_relationship_between_communities_in_this_location}
          />
        </SlidePanel>
        <SlidePanel>
          <ChartPieWidgetByKey
