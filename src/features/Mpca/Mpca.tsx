...
import {Deduplication} from '@/features/Mpca/Deduplication/Deduplication'
...
const MPCASidebar = () => {
  ...
  return (
    <Sidebar headerId="app-header">
      <SidebarBody>
        <SidebarItem component={NavLink} icon="equalizer" to={path(mpcaModule.siteMap.deduplication)}>{m.dashboard}</SidebarItem>
        <SidebarItem component={NavLink} icon="equalizer" to={path(mpcaModule.siteMap.dashboard)}>{m.dashboard}</SidebarItem>
        <SidebarItem component={NavLink} icon="content_copy" to={path(mpcaModule.siteMap.data)}>{m.deduplication}</SidebarItem>
  ...
  return (
    <Router>
      <MPCADeduplicationProvider db={db}>
        ...
        >
          <Routes>
            <Route path={mpcaModule.siteMap.deduplication} element={<Deduplication/>}/>
            <Route path={mpcaModule.siteMap.data} element={<MpcaDedupTable/>}/>
