      ...
      return api.mpca.search({filters}).then(res => {
        ...
        Utils.groupBy({
          ...
          finalTransform: (group, [oblast, raion, Hromada, populationGroup]) => {
            const disag = Person.groupByGenderAndGroup(Person.ageGroup.Quick)(group.flatMap(_ => _.persons).compact())
            const activity = {
              ...
              'Adult Women': disag['18 - 49']?.Female,
              'Adult Men': disag['18 - 49']?.Male,
              'Elderly Women': disag['50+']?.Female,
              'Elderly Men': disag['50+']?.Male,
