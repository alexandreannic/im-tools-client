...
// export const renderKoboDatabaseColumns = ({
//   q,
//   row,
//   formatDate,
//   onOpenBeginRepeat,
...
//   formatDate: I18nContextProps['formatDate']
//   q: KoboQuestionSchema,
//   row: KoboAnswer<any>,
//   translateOption: KoboDatabaseContext['schema']['translateOption'],
//   langIndex?: number
// }) => {
//   switch (q.type) {
//     case 'image': {
...
export const KoboDatabaseBody = memo(({
  ...
  // const {translateOption, langIndex} = useKoboDatabaseContext()
  return (
    <tbody>
    {data.map(row =>
      <tr key={row.id}>
        ...
        <td className="td-sticky-end">
          <AAIconBtn icon="print"/>
        </td>
      </tr>
    )}
    </tbody>
