export const kobo = {
  drcUa: {
    ...
    form: {
      ...
      bn_oldMpcaNfiNaa: 'aBGVXW2N26DaLehmKneuyB' as const,
      bn_re: 'aKgX4MNs6gCemDQKPeXxY8' as const,
      meal_visitMonitoring: 'a8GkjWBQDfxVADGHWJDrUw' as const,
      meal_cfmInternal: 'aN3Y8JeH2fU3GthrWAs9FG' as const,
      meal_cfmExternal: 'aJaGLvGEdpYWk5ift8k87y' as const,
      shelter_nta: 'aL8oHMzJJ9soPepvK6YU9E' as const,
